...
if(isset($_POST['submit'])) {
    ...
    if ($compIdExists)
        ...
        $query = "insert into Company values ('$compAfm','$compName','$compEmail','$compPhone','$doi','$ika','$uId')";
...
<form id="form" class="menu_content wrapper hoc form-box" action="" method="post">
    ...
    <div class="form-controls">
        <label for="ika">ΙΚΑ-ΕΤΑΜ <span class="text-danger">*</span></label>
