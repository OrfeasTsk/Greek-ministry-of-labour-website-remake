...
<div style="height: 1500px">
    ...
    <div class="wrapper bgded overlay" style="background-color:royalblue">
        <div id="breadcrumb" class="hoc clear">
            <!-- ################################################################################################ -->
            <h1  class="pagetitle">Συνθήκες Εργασίας</h1>
            <ul>
                <li><a href="../../../index.php">ΑΡΧΙΚΗ</a></li>
                <li><a href="../employees.php">ΕΡΓΑΖΟΜΕΝΟΙ</a></li>
                <li style="color: dodgerblue">ΣΥΝΘΗΚΕΣ ΕΡΓΑΣΙΑΣ</li>
            </ul>
            <!-- ################################################################################################ -->
        </div>
    </div>
                ...
                <div>
                    <figure>
                        <ul id="gallery" class="nospace clear">
                            <li class="one_third first"><a href="../../MISC/under_constr.html">Ασφάλεια και Υγεία στην Εργασία</a></li>
                            <li class="one_third"><a href="suspension.php?employee=true">Αναστολή Σύμβασης Εργασίας</a></li>
                            <li class="one_third"><a href="telework.php?employee=true">Τηλεργασία</a></li>
                        </ul>
                    </figure>
                </div>
