...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-color:#4169e1">
    <div id="breadcrumb" class="hoc clear">
        <!-- ################################################################################################ -->
        <h1  class="pagetitle">Εργαζόμενοι</h1>
        <ul>
            <li><a href="../../index.php">ΑΡΧΙΚΗ</a></li>
            <li style="color: dodgerblue">ΕΡΓΑΖΟΜΕΝΟΙ</li>
        </ul>
        <!-- ################################################################################################ -->
    </div>
</div>

<div class="menu_content wrapper hoc">
    <details open>
        <summary><a href="LEAVE/leave.php">Άδειες</a></summary>
        <ol>
            <li><a href="../MISC/under_constr.html">Άδεια λόγω ασθένειας</a></li>
            <li><a href="../MISC/under_constr.html">Άδεια ειδικού σκοπού</a></li>
            <li><a href="LEAVE/parental_leave.php">Γονική άδεια</a></li>
        </ol>
    </details>
    <details open>
        <summary><a href="../MISC/under_constr.html">Συμβάσεις Eργασίας</a></summary>
        <ol>
            <li><a href="../MISC/under_constr.html">Μισθοδοσία</a></li>
            <li><a href="../MISC/under_constr.html">Ωράριο εργασίας</a></li>
            <li><a href="../MISC/under_constr.html">Καταγγελίες</a></li>
        </ol>
    </details>
    <details class="no_content">
        <summary><a href="../MISC/under_constr.html">Επιδόματα Eργαζομένων</a></summary>
    </details>
    <details open>
        <summary><a href="WORKCOND/workcond.php">Συνθήκες Eργασίας</a></summary>
        <ol>
            <li><a href="../MISC/under_constr.html">Ασφάλεια και υγεία στην εργασία</a></li>
            <li><a href="WORKCOND/suspension.php?employee=true">Αναστολη σύμβασης εργασίας</a></li>
            <li><a href="WORKCOND/telework.php?employee=true">Τηλεργασία</a></li>
        </ol>
    </details>
</div>
</div>
