...
<div style="height: 1500px">
    ...
    <div class="wrapper bgded overlay" style="background-color:royalblue">
        <div id="breadcrumb" class="hoc clear">
            <!-- ################################################################################################ -->
            <h1  class="pagetitle">Άδειες</h1>
            <ul>
                <li><a href="../../../index.php">ΑΡΧΙΚΗ</a></li>
                <li><a href="../employees.php">ΕΡΓΑΖΟΜΕΝΟΙ</a></li>
                <li style="color: dodgerblue">ΑΔΕΙΕΣ</li>
            </ul>
            <!-- ################################################################################################ -->
        </div>
    </div>
                ...
                <div>
                    <figure>
                        <ul id="gallery" class="nospace clear">
                            <li class="one_third first"><a href="../../MISC/under_constr.html">Άδεια λόγω Ασθένειας</a></li>
                            <li class="one_third"><a href="../../MISC/under_constr.html">Άδεια Ειδικού Σκοπού</a></li>
                            <li class="one_third"><a href="parental_leave.php">Γονική Άδεια</a></li>
                        </ul>
                    </figure>
                </div>
