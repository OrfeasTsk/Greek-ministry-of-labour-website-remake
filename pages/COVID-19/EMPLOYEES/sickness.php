    ...
    <div class="wrapper bgded overlay" style="background-color:royalblue">
        <div id="breadcrumb" class="hoc clear">
            ...
            <ul>
                ...
                <li><a href="employees.php">ΓΙΑ ΤΟΝ ΕΡΓΑΖΟΜΕΝΟ</a></li>
                <li style="color: dodgerblue">ΕΚΔΗΛΩΣΗ ΣΥΜΠΤΩΜΑΤΟΣ</li>
            </ul>
            <!-- ################################################################################################ -->
        </div>
    </div>
    ...
    <div  style="margin-bottom: 0px" class="hoc menu_content wrapper row2">
        ...
        <main class="hoc container clear">
            ...
            <div class="content text">
                <!-- ################################################################################################ -->
                <ul>
                    <h3 ><b>Απαραίτητες ενέργειες σε περίπτωση εκδήλωσης των συμπτωμάτων σε εργαζόμενο
                        κατά τη διάρκεια εργασίας του</b> </h3>

                    <p>Εργαζόμενος που εμφανίσει αιφνιδίως συμπτώματα (πυρετό, βήχα, αγευσία ή αοσμί, πονοκέφαλο, ρίγος, πονοκέφαλο)
                        αναμένει σε χώρο όπου δε θα έρχεται σε επαφή με άλλα άτομα και
                        ενημερώνονται ο ιατρός εργασίας (όπου υπάρχει) και ο προϊστάμενος. </p>

                    <p>Στη περίπτωση που δεν υπάρχει ιατρός εργασίας, ειδοποιείται άμεσα ο ΕΟΔΥ ώστε να παράσχει τις απαραίτητες
                        ...
                        με τις οδηγίες του ΕΟΔΥ όπως αναγράφονται στην αντίστοιχη
                        <a href="https://eody.gov.gr/wp-content/uploads/2020/05/covid19-apolimansi-14-05-20.pdf" target="_blank"> ιστοσελίδα</a>.</li></p>

                    <p>Σε περιπτώσεις που είναι εφικτό, συνιστάται η
                        <a href="../../EMPLOYEES/WORKCOND/telework.php" target="_blank"> εξ’ αποστάσεως εργασία</a>.</li></p>
                    .</p>

                    <img src="../../../images/flowchart_2.jpg">

                    <br><br><br><br><br><br><br><br><br><br>
                    <p>Κάθε εργαζόμενος έχει υποχρέωση να εφαρμόζει τους κανόνες υγείας και ασφάλειας και να φροντίζει
                        ...
                        σύμφωνα με την εκπαίδευσή του και τις κατάλληλες οδηγίες του εργοδότη του.</p>
                    <p>Για την πραγματοποίηση
                        αυτών των στόχων, οι εργαζόμενοι οφείλουν να αναφέρουν αμέσως στον εργοδότη ή/και σε
                        ...
                        και κάθε έλλειψη που διαπιστώνεται στα συστήματα προστασίας.</p> <br><br>
                    <center>
                    <img src="../../../images/symptoms_2.jpg">
                    </center>
                </ul>
                <!-- ################################################################################################ -->
                <!-- / main body -->
