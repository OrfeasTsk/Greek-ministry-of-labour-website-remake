...
if(isset($_POST['login_submit'])){
    ...
    if($rows == 1){
        ...
        if(password_verify($password,$user['password'])) {
            ...
            header("Location: personal_hygiene.php");
        }
        else{
    ...
    <div class="wrapper bgded overlay" style="background-color:royalblue">
        <div id="breadcrumb" class="hoc clear">
            ...
            <ul>
                ...
                <li style="color: dodgerblue">ΑΤΟΜΙΚΗ ΥΓΙΕΙΝΗ</li>
            </ul>
            <!-- ################################################################################################ -->
        </div>
    </div>
    ...
    <div  style="margin-bottom: 0px" class="hoc menu_content wrapper row2">
        ...
        <main class="hoc container clear">
            ...
            <div class="content text">
                <!-- ################################################################################################ -->
                <h3 ><b>Γενικές οδηγίες ατομικής υγιεινής</b> </h3>
                <ul>
                    <p>Το πλύσιμο και η απολύμανση των χεριών είναι ιδιαιτέρως απαραίτητα:</p>
                        ...
                        γάντια.</li>
                    <br>
                    <ul><img src="../../../images/handwashing.png"/></ul>

                    <p>Όταν βήχουμε ή φταρνιζόμαστε, καλύπτουμε το στόμα μας με τον αγκώνα ή ένα χαρτομάντιλο και
                        πλένουμε ή απολυμαίνουμε τα χέρια μας:</p>
                    <li>Απορρίπτουμε το χαρτομάντιλο, αμέσως
                        μετά τη χρήση, σε σκεπαστό κάδο</li>
                    <li>Αποφεύγουμε τις κοντινές επαφές ειδικά
                        με άτομα που παρουσιάζουν συμπτώματα
                        όπως πυρετό, βήχα, πονόλαιμο και
                        καταρροή.</li>

                    <p>Οι εργαζόμενοι που παρουσιάζουν ένα ή περισσότερα από τα παρακάτω συμπτώματα νόσου όπως
                        πυρετό, βήχα, πονόλαιμο, καταρροή, θα πρέπει να τηρήσουν τις οδηγίες του ΕΟΔΥ:</p>
                    <li>Ενημερώνουμε τον εργοδότη ή την
                        υπηρεσία μας</li>
                    <li>Επικοινωνούμε με το θεράποντα ιατρό μας</li>
                    <li>Επικοινωνούμε με τον ΕΟΔΥ (τηλέφωνα
                        επικοινωνίας 210.52.12.054 ή 1135).</li>
                </ul>
                <!-- ################################################################################################ -->
                <!-- / main body -->
                <div class="clear"></div>
