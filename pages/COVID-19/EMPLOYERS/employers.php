    ...
    <div class="wrapper bgded overlay" style="background-color:royalblue">
        <div id="breadcrumb" class="hoc clear">
            ...
            <ul>
                ...
                <li style="color: dodgerblue">ΓΙΑ ΤΟΝ ΕΡΓΟΔΟΤΗ</li>
            </ul>
            <!-- ################################################################################################ -->
        </div>
    </div>
                ...
                <div>
                    <figure>
                        <ul id="gallery" class="nospace clear">
                            <li class="one_third first"><a href="organization.php">Οργανωτικά Μέτρα</a></li>
                            <li class="one_third"><a href="health_measures.php">Μέτρα Υγιεινής και Προστασίας</a></li>
                            <li class="one_third"><a href="suspension.php">Αναστολή Σύμβασης Εργασίας</a></li>
                            <li class="one_third first"><a href="telework.php">Τηλεργασία</a></li>
                            <li class="one_third"><a href="../../MISC/under_constr.html">Υπολογισμός Ασφαλιστικών Εισφορών</a></li>
