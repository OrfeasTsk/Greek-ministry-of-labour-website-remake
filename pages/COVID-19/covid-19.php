...
<div class="wrapper bgded overlay" style="background-color:royalblue">
    <div id="breadcrumb" class="hoc clear">
        <!-- ################################################################################################ -->
        <h1  class="pagetitle">COVID-19</h1>
        <ul>
            <li><a href="../../index.php">ΑΡΧΙΚΗ</a></li>
            <li style="color: dodgerblue">COVID-19</li>
        </ul>
        <!-- ################################################################################################ -->
    </div>
</div>
...
<div class="menu_content wrapper hoc">
    <details class="no_content">
        <summary><a href="general_information.php">Γενικές Πληροφορίες</a></summary>
    </details>
    <details open>
        <summary><a href="EMPLOYEES/employees.php">Πληροφορίες για τον Εργαζόμενο</a></summary>
        <ol>
            <li><a href="EMPLOYEES/hygiene.php">Ατομική Υγιεινή</a></li>
            <li><a href="EMPLOYEES/sickness.php">Εκδήλωση Συμπτώματος</a></li>
            <li><a href="../MISC/under_constr.html">Επιδότηση λόγω COVID-19</a></li>
        </ol>
    </details>
    <details open>
        <summary><a href="EMPLOYERS/employers.php">Πληροφορίες για τον Εργοδότη</a></summary>
        <ol>
            <li><a href="EMPLOYERS/organization.php">Οργανωτικά Μέτρα</a></li>
            <li><a href="EMPLOYERS/health_measures.php">Μέτρα Υγιεινής και Προστασίας</a></li>
            <li><a href="EMPLOYERS/suspension.php">Αναστολή Σύμβασης Εργασίας</a></li>
            <li><a href="EMPLOYERS/telework.php">Τηλεργασία</a></li>
            <li><a href="../MISC/under_constr.html">Υπολογισμός Ασφαλιστικών Εισφορών</a></li>
            <li><a href="../MISC/under_constr.html">Επιδότηση λόγω COVID-19</a></li>
        </ol>
    </details>
</div>
