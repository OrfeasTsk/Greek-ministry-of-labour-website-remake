...
if(isset($_POST['login_submit'])){
    ...
    if($rows == 1){
        ...
        if(password_verify($password,$user['password'])) {
            ...
            header("Location: other_groups.php");
        }
        else{
...
<div class="wrapper bgded overlay" style="background-color:royalblue">
    <div id="breadcrumb" class="hoc clear">
        <!-- ################################################################################################ -->
        <h1  class="pagetitle">Άλλες Ομάδες</h1>
        <ul>
            <li><a href="../index.php">ΑΡΧΙΚΗ</a></li>
            <li style="color: dodgerblue">αλλες Ομαδες</li>
        </ul>
        <!-- ################################################################################################ -->
    </div>
</div>
...
<div class="menu_content wrapper hoc">
    <details open>
        <summary><a href="MISC/under_constr.html">Συνταξιούχοι</a></summary>
        <ol>
            <li><a href="MISC/under_constr.html">Συντάξεις</a></li>
        </ol>
    </details>
    <details open>
        <summary><a href="MISC/under_constr.html">Άνεργοι</a></summary>
        <ol>
            <li><a href="MISC/under_constr.html">Πρόγραμμα υποστήριξης</a></li>
        </ol>
    </details>
    <details open>
        <summary><a href="MISC/under_constr.html">Νεολαία</a></summary>
        <ol>
            <li><a href="MISC/under_constr.html">Επαγγελματικός προσανατολισμός</a></li>
        </ol>
    </details>
</div>
</div>
