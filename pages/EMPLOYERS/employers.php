            ...
            <ul class="clear">
                ...
                <li><a class="drop" href="employers.php">ΕΡΓΟΔΟΤΕΣ</a>
                    <ul>
                        ...
                        <li><a href="WORKFORCE/workforce.php">ΑΝΘΡΩΠΙΝΟ ΔΥΝΑΜΙΚΟ</a></li>
                    </ul>
                </li>
...
<div class="wrapper bgded overlay" style="background-color:royalblue">
    <div id="breadcrumb" class="hoc clear">
        <!-- ################################################################################################ -->
        <h1  class="pagetitle">Εργοδότες</h1>
        <ul>
            <li><a href="../../index.php">ΑΡΧΙΚΗ</a></li>
            <li style="color: dodgerblue">ΕΡΓΟΔΟΤΕΣ</li>
        </ul>
        <!-- ################################################################################################ -->
    </div>
</div>
...
<div class="menu_content wrapper hoc">
    <details open>
        <summary><a href="../MISC/under_constr.html">Επιχειρησιακά Θέματα</a></summary>
        <ol>
            <li><a href="../MISC/under_constr.html">Κανονισμός εργασίας επιχείρησης</a></li>
            <li><a href="../MISC/under_constr.html">Νομοθεσία</a></li>
        </ol>
    </details>
    <details open>
        <summary><a href="WORKFORCE/workforce.php">Ανθρώπινο Δυναμικό</a></summary>
        <ol>
            <li><a href="WORKFORCE/suspension.php">Αναστολή σύμβασης εργασίας</a></li>
            <li><a href="../MISC/under_constr.html">Απολύσεις-Ομαδικές απολύσεις</a></li>
            <li><a href="../MISC/under_constr.html">Προσλήψεις</a></li>
            <li><a href="WORKFORCE/telework.php">Τηλεργασία</a></li>
        </ol>
    </details>
