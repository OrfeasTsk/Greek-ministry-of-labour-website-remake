...
<div class="wrapper bgded overlay" style="background-color:royalblue">
    <div id="breadcrumb" class="hoc clear">
        <!-- ################################################################################################ -->
        <h1  class="pagetitle">Ανθρώπινο Δυναμικό</h1>
        <ul>
            <li><a href="../../../index.php">ΑΡΧΙΚΗ</a></li>
            <li><a href="../employers.php">ΕΡΓΟΔΟΤΕΣ</a></li>
            <li style="color: dodgerblue">ΑΝΘΡΩΠΙΝΟ ΔΥΝΑΜΙΚΟ</li>
        </ul>
        <!-- ################################################################################################ -->
    </div>
</div>
            ...
            <div>
                <figure>
                    <ul id="gallery" class="nospace clear">
                        <li class="one_third first"><a href="suspension.php">Αναστολή Σύμβασης Εργασίας</a></li>
                        <li class="one_third"><a href="../../MISC/under_constr.html">Απολύσεις - Ομαδικές Απολύσεις</a></li>
                        <li class="one_third"><a href="../../MISC/under_constr.html">Προσλήψεις</a></li>
                        <li class="one_third first"><a href="telework.php">Τηλεργασία</a></li>
                    </ul>
                </figure>
            </div>
